...
// Liquidity providers (HomePage.md). The motif is a two-sided private quote
// ladder: teal bids ↔ spread ↔ magenta asks ("quote both sides"), edges fade
// into the page ("keep your book to yourself"), and the bars breathe slowly
// from the spread outward ("agents keep quotes fresh while you sleep").
// Near-spread levels carry the most depth, tapering outward.
      ...
      <div className="mx-auto max-w-3xl px-6 py-20 text-center md:py-24">
        <Reveal>
          ...
          <p className="mx-auto mt-5 max-w-xl text-muted">
            Grid orders and RFQ provision on private rails — your inventory, spreads, and
            pricing logic stay invisible to the market. Configure depth and risk once;
            agents keep quotes fresh while you sleep. Every settled fill counts toward
            EarnHub rewards.
          </p>

          {/* two-sided private quote ladder */}
          <div
            className="mx-auto mt-10 flex max-w-110 flex-col gap-1.5"
            style={{
              maskImage:
              ...
              <div key={i} className="grid h-3 grid-cols-[1fr_14px_1fr] items-center">
                <motion.span
                  ...
                  style={{
                    ...
                    // teal --data, fading toward the outer edge
                    background:
                ...
                />
                <span className="h-[140%] w-px justify-self-center bg-white/25" />
                <motion.span
                  className="h-full justify-self-start rounded-r-sm"
                  style={{
                    width: `${ASKS[i]}%`,
                    transformOrigin: "left",
                    // magenta --accent, fading toward the outer edge
                    background:
