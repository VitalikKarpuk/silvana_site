// Logo wall (HomePage.md) — partners, monochrome.
...
// wordmarks are flattened to a uniform white silhouette (`mono`) to satisfy the
// monochrome spec and stay legible on the dark base. Supanova is already a light
// mark, so it renders as-is. Loop Wallet has no asset yet → text placeholder.
type Partner =
...
export function LogoWall() {
  return (
    <section className="border-b border-line" aria-label="Partners">
